...
* @property {String|Array.<String>|Function} [trustProxy] If a reverse proxy is used, this setting must be configured. See https://www.npmjs.com/package/proxy-addr for possible values.
*/
