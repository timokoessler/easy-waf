...
const regex = new RegExp(`(${dotRegex}{2,3};?${slashRegex}|${slashRegex};?${dotRegex}{2,3}|${slashRegex}(etc|proc|home|run|var|usr|root|bin|cgi-bin|windows|system32)${slashRegex}|c(:|%3A|%253A)${slashRegex}|${slashRegex}${dotRegex}${slashRegex}|boot.ini|.htaccess)`, 'i');
