import { quotationMarks, singleQuotationMarks, curlyBracketOpen, squareBracketOpen, dollar, colon, squareBracketClose, dot, brackedOpen, underscore, or, equals, and } from './specialchars.regex';
